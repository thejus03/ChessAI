                    ...
                    if (self.board.squares[clicked_row][clicked_col].has_piece()):
                        ...
                        if piece.color == self.game.player:
                            if self.board.in_check(self.game.player):
                                ...
                                self.board.calc_moves(clicked_row, clicked_col, check=False)
                ...
                # Released click
                    ...
                    if self.dragger.dragging:
                        ...
                        if self.board.valid_move(piece, (released_row, released_col)):
                            ...
                            # Set en_passant to False for all pawns of the opposite color
                            self.board.set_en_passant_false("white" if piece.color == "black" else "black") 
